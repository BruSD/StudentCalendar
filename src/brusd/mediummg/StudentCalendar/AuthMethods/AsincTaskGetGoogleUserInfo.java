package brusd.mediummg.StudentCalendar.AuthMethods;
...
/**
 * Created by BruSD on 24.10.13.
 */
public  class AsincTaskGetGoogleUserInfo extends AsyncTask  {
    ...
    public AsincTaskGetGoogleUserInfo(Activity activity, String email, String scope, int requestCode) {
    ...
    private void fetchNameFromProfileServer() throws IOException, JSONException {
        ...
        if (sc == 200) {
            ...
            //TODO: Make return of accaunt data
